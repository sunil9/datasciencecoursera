...
# Course Project: Collect, work with, and clean a data set
...
#     average of each variable for each activity and each subject.
  ...
  tidyDataFile <- "./UCI_HAR_Dataset_Tidy.txt"
  # tidyDataFileAVG <- "./UCI_HAR_Dataset_Tidy_AVG.csv"
  # Directory and filename (.txt) of the clean/tidy data
  tidyDataFileAVGtxt <- "./UCI_HAR_Dataset_Tidy_AVG.txt"
